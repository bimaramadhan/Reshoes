...
class ShareController2 extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shares2.index', compact('shares'));
    }
    ...
    public function store(Request $request)
    {
      ...
      $share->save();
      return redirect('/shares2')->with('success', 'Order has been added');
    }
    ...
    public function edit($id)
    {
        ...
        return view('shares2.edit', compact('share'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/shares2')->with('success', 'Order has been deleted Successfully');
    }
}
