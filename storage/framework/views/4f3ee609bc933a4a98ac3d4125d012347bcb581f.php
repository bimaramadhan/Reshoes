...
<head>
  ...
  <script type="text/javascript" src="<?php echo e(url('js/homepage.js')); ?>"></script>
...
<body>
  ...
  <div class="topnav">
    <link href="<?php echo e(url('css/homepage.css')); ?>" rel="stylesheet" type="text/css" />
      ...
      <a class="right" href="<?php echo e(route('register')); ?>">Register</a>
      <a class="right" href="<?php echo e(route('login')); ?>">Login</a>  
  </div>
